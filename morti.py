...
# Paddding the Sequence with <PAD> tokens
...
# Splitting the Q & A into training and Validation Sets
...
for epoch in range(1, epochs + 1):
    ...
    if average_validation_loss_error <= min(list_validation_loss_error):
        ...
        print('sorry, i got dummer. need to pracitce more')
        early_stopping_check += 1
        if early_stopping_check == early_stopping_stop:
            break
if early_stopping_check == early_stopping_stop:
    print("sorry, i cannot improve myself yet.")
    break
print('game over')
